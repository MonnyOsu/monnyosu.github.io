...
/* harmony export */   "getTasksToday": () => (/* binding */ getTasksToday),
/* harmony export */   "getTasksThisWeek": () => (/* binding */ getTasksThisWeek)
/* harmony export */ });
...
function getTasksToday(project) {
    return project.tasks.filter((task) => {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(task.dueDate)) {
            return task;
        }
    })
}
...
function getTasksThisWeek() {
    return this.tasks.filter((task) => {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((task.dueDate), { weekStartsOn: 1 }) === true) {
            return task;
        }
    })
}
...
function getDueDateLengthDays(task) {
    return `Due in ${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(task.dueDate))}`;
}
